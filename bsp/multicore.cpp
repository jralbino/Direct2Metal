...
extern "C" void secondary_main() {
    ...
    while (1) {
        ...
        if (type == TASK_CONV2D) {
             ...
             * `cls` (P3/P4/P5) nunca se escriben. `TASK_CONV1X1` (justo
             * abajo) sí lo hacía bien; solo faltaba aquí. Latente desde V180
             * porque hasta V199 el HW iba por el reparto async, que también
             * lo hacía bien; se destapó al medirlo (V198). */
