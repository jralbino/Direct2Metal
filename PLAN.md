...
> Estado: **V188** — cámara: AE con protección de altas luces (blancos quemados resueltos: recorte R/B 42/45 % → 4/6 %), AWB grey-world, imagen de cámara en pantalla (`SHOW_CAMERA`), `FRAME_SKIP_N=4` por defecto, relojes stock 1 GHz (V187), captura de frame real por UART (`make capture`, V185). Ver filas V185–V188.
