...
> Estado: **V190** — conv1x1 con transpose de la entrada: **664 ms/frame** (−17 % vs V189). L2 cv2 1×1 55→7.8 ms, L15 79→31. Bit-exacto. Golden = frame real de cámara (`clock` 83 %).
> V189 — golden real + primer timing a 1 GHz (799 ms).
