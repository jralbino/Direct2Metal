...
> Estado: **V191** — P8 por-posición-safe (8ch + 4ch): **541 ms/frame** (−32 % vs V189, −18 % vs V190). P3 head 3×3 141→105, L2 bot 3×3 32→14. Bit-exacto. Golden = frame real de cámara (`clock` 83 %).
> V190 — conv1x1 transpose (664 ms). V189 — golden real + 1 GHz (799 ms).
