...
> Estado: **V193** — **Winograd F(2×2,3×3) implementado, validado y CERRADO** (verdicto negativo, ver fila V193). El estado de rendimiento sigue en **V192: 492 ms/frame HW @1 GHz**, campo de visión completo (entrada no cuadrada 320×192). YOLOv8n es fully-conv → mismos pesos. Golden = frame de cámara recapturado (`clock` 56 %, huella `[ABS]` PASS 16/16). En GitHub `main` (hasta `3ad18eb`; V193 aún sin push).
>
